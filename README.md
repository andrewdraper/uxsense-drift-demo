...
- **[#2 — Give the results list an even vertical rhythm](https://github.com/uxsense-ai/uxsense-drift-demo/pull/2)**
...
- **[#4 — Lead the results with price, and rename ServicesPage](https://github.com/uxsense-ai/uxsense-drift-demo/pull/4)**
